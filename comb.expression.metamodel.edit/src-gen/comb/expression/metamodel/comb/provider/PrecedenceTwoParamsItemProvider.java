...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.PrecedenceTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrecedenceTwoParamsItemProvider extends PrecedenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PrecedenceTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.PRECEDENCE_TWO_PARAMS__Q);
			childrenFeatures.add(CombPackage.Literals.PRECEDENCE_TWO_PARAMS__R);
		}
	...
	public String getText(Object object) {
		String label = ((PrecedenceTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_PrecedenceTwoParams_type")
				: getString("_UI_PrecedenceTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrecedenceTwoParams.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.PRECEDENCE_TWO_PARAMS__Q,
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.PRECEDENCE_TWO_PARAMS__R,
				CombFactory.eINSTANCE.createPrecedenceAfter_until_()));
