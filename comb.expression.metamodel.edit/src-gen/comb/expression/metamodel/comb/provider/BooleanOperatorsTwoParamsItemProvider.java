...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.BooleanOperatorsTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanOperatorsTwoParamsItemProvider extends BooleanOperatorsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BooleanOperatorsTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.BOOLEAN_OPERATORS_TWO_PARAMS__Q);
		}
	...
	public String getText(Object object) {
		String label = ((BooleanOperatorsTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_BooleanOperatorsTwoParams_type")
				: getString("_UI_BooleanOperatorsTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanOperatorsTwoParams.class)) {
