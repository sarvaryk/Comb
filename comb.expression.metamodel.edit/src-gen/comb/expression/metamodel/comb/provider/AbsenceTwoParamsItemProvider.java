...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.AbsenceTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbsenceTwoParamsItemProvider extends AbsenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AbsenceTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.ABSENCE_TWO_PARAMS__R);
			childrenFeatures.add(CombPackage.Literals.ABSENCE_TWO_PARAMS__Q);
		}
	...
	public String getText(Object object) {
		String label = ((AbsenceTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AbsenceTwoParams_type")
				: getString("_UI_AbsenceTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbsenceTwoParams.class)) {
		case CombPackage.ABSENCE_TWO_PARAMS__R:
		case CombPackage.ABSENCE_TWO_PARAMS__Q:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__R,
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__R, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__R, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__R, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__R, CombFactory.eINSTANCE.createNot_()));
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__Q,
				CombFactory.eINSTANCE.createPrecedenceAfter_until_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__Q, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__Q, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__Q, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_TWO_PARAMS__Q, CombFactory.eINSTANCE.createNot_()));
