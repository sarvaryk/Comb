...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.LTLOperators} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LTLOperatorsItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LTLOperatorsItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((LTLOperators) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LTLOperators_type")
				: getString("_UI_LTLOperators_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LTLOperators.class)) {
