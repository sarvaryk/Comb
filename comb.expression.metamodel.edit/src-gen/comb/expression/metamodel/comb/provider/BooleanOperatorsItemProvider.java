...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.BooleanOperators} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanOperatorsItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BooleanOperatorsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.BOOLEAN_OPERATORS__P);
		}
	...
	public String getText(Object object) {
		String label = ((BooleanOperators) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_BooleanOperators_type")
				: getString("_UI_BooleanOperators_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanOperators.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P,
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.create_until_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.createAlways_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.createLiteral()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.createNot_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.BOOLEAN_OPERATORS__P, CombFactory.eINSTANCE.create_equal_()));
