...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.MITLOperatorsTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MITLOperatorsTwoParamsItemProvider extends MITLOperatorsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MITLOperatorsTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.MITL_OPERATORS_TWO_PARAMS__Q);
		}
	...
	/**
	 * This returns MITLOperatorsTwoParams.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MITLOperatorsTwoParams"));
	}
	...
	public String getText(Object object) {
		String label = ((MITLOperatorsTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_MITLOperatorsTwoParams_type")
				: getString("_UI_MITLOperatorsTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MITLOperatorsTwoParams.class)) {
		case CombPackage.MITL_OPERATORS_TWO_PARAMS__Q:
