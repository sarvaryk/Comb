...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.STRELOperatorsTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class STRELOperatorsTwoParamsItemProvider extends STRELOperatorsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public STRELOperatorsTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.STREL_OPERATORS_TWO_PARAMS__Q);
		}
	...
	/**
	 * This returns STRELOperatorsTwoParams.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/STRELOperatorsTwoParams"));
	}
	...
	public String getText(Object object) {
		String label = ((STRELOperatorsTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_STRELOperatorsTwoParams_type")
				: getString("_UI_STRELOperatorsTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(STRELOperatorsTwoParams.class)) {
		case CombPackage.STREL_OPERATORS_TWO_PARAMS__Q:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.STREL_OPERATORS_TWO_PARAMS__Q,
