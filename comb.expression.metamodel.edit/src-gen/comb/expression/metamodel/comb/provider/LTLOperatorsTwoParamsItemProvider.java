...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.LTLOperatorsTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LTLOperatorsTwoParamsItemProvider extends LTLOperatorsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LTLOperatorsTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.LTL_OPERATORS_TWO_PARAMS__Q);
		}
	...
	public String getText(Object object) {
		String label = ((LTLOperatorsTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_LTLOperatorsTwoParams_type")
				: getString("_UI_LTLOperatorsTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LTLOperatorsTwoParams.class)) {
		case CombPackage.LTL_OPERATORS_TWO_PARAMS__Q:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.LTL_OPERATORS_TWO_PARAMS__Q,
