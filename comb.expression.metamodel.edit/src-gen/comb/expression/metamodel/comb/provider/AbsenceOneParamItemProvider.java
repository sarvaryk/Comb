...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.AbsenceOneParam} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbsenceOneParamItemProvider extends AbsenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AbsenceOneParamItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.ABSENCE_ONE_PARAM__Q);
		}
	...
	public String getText(Object object) {
		String label = ((AbsenceOneParam) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AbsenceOneParam_type")
				: getString("_UI_AbsenceOneParam_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbsenceOneParam.class)) {
		case CombPackage.ABSENCE_ONE_PARAM__Q:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_until_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.createAlways_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.createLiteral()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.createNot_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.ABSENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_equal_()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == CombPackage.Literals.LTL_OPERATORS__P
				|| childFeature == CombPackage.Literals.ABSENCE_ONE_PARAM__Q;
