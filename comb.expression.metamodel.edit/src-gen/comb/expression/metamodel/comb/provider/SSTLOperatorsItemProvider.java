...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.SSTLOperators} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SSTLOperatorsItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SSTLOperatorsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.SSTL_OPERATORS__P);
		}
	...
	/**
	 * This returns SSTLOperators.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SSTLOperators"));
	}
	...
	public String getText(Object object) {
		String label = ((SSTLOperators) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_SSTLOperators_type")
				: getString("_UI_SSTLOperators_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SSTLOperators.class)) {
		case CombPackage.SSTL_OPERATORS__P:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P,
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.create_until_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.createAlways_()));
		...
		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.create_implies_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.createLiteral()));

		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.createNot_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.create_lessThan_()));

		newChildDescriptors.add(createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P,
				CombFactory.eINSTANCE.create_lessThanOrEqual_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.SSTL_OPERATORS__P, CombFactory.eINSTANCE.create_equal_()));
