...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.MTLOperatorsTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MTLOperatorsTwoParamsItemProvider extends MTLOperatorsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MTLOperatorsTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.MTL_OPERATORS_TWO_PARAMS__Q);
		}
	...
	/**
	 * This returns MTLOperatorsTwoParams.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MTLOperatorsTwoParams"));
	}
	...
	public String getText(Object object) {
		String label = ((MTLOperatorsTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_MTLOperatorsTwoParams_type")
				: getString("_UI_MTLOperatorsTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MTLOperatorsTwoParams.class)) {
		case CombPackage.MTL_OPERATORS_TWO_PARAMS__Q:
