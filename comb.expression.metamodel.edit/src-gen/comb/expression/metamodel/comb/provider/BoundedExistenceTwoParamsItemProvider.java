...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.BoundedExistenceTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoundedExistenceTwoParamsItemProvider extends BoundedExistenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BoundedExistenceTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.BOUNDED_EXISTENCE_TWO_PARAMS__Q);
			childrenFeatures.add(CombPackage.Literals.BOUNDED_EXISTENCE_TWO_PARAMS__R);
		}
	...
	public String getText(Object object) {
		String label = ((BoundedExistenceTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_BoundedExistenceTwoParams_type")
				: getString("_UI_BoundedExistenceTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BoundedExistenceTwoParams.class)) {
		case CombPackage.BOUNDED_EXISTENCE_TWO_PARAMS__Q:
		case CombPackage.BOUNDED_EXISTENCE_TWO_PARAMS__R:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.BOUNDED_EXISTENCE_TWO_PARAMS__Q,
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.BOUNDED_EXISTENCE_TWO_PARAMS__R,
				CombFactory.eINSTANCE.createPrecedenceAfter_until_()));
