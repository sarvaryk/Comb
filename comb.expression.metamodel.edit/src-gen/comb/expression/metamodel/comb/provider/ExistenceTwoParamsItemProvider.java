...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.ExistenceTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExistenceTwoParamsItemProvider extends ExistenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ExistenceTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.EXISTENCE_TWO_PARAMS__R);
			childrenFeatures.add(CombPackage.Literals.EXISTENCE_TWO_PARAMS__Q);
		}
	...
	public String getText(Object object) {
		String label = ((ExistenceTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ExistenceTwoParams_type")
				: getString("_UI_ExistenceTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExistenceTwoParams.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.EXISTENCE_TWO_PARAMS__R,
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTENCE_TWO_PARAMS__R, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTENCE_TWO_PARAMS__R, CombFactory.eINSTANCE.createNot_()));
		...
		newChildDescriptors.add(createChildParameter(CombPackage.Literals.EXISTENCE_TWO_PARAMS__Q,
				CombFactory.eINSTANCE.createPrecedenceAfter_until_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTENCE_TWO_PARAMS__Q, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTENCE_TWO_PARAMS__Q, CombFactory.eINSTANCE.createNot_()));
