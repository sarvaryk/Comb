...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.UniversalityOneParam} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UniversalityOneParamItemProvider extends UniversalityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UniversalityOneParamItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.UNIVERSALITY_ONE_PARAM__Q);
		}
	...
	public String getText(Object object) {
		String label = ((UniversalityOneParam) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_UniversalityOneParam_type")
				: getString("_UI_UniversalityOneParam_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UniversalityOneParam.class)) {
