...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.ResponseOneParam} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponseOneParamItemProvider extends ResponseItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ResponseOneParamItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.RESPONSE_ONE_PARAM__Q);
		}
	...
	public String getText(Object object) {
		String label = ((ResponseOneParam) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ResponseOneParam_type")
				: getString("_UI_ResponseOneParam_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ResponseOneParam.class)) {
		case CombPackage.RESPONSE_ONE_PARAM__Q:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.RESPONSE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.RESPONSE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.RESPONSE_ONE_PARAM__Q, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.RESPONSE_ONE_PARAM__Q, CombFactory.eINSTANCE.createNot_()));
