...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.UniversalityTwoParams} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UniversalityTwoParamsItemProvider extends UniversalityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UniversalityTwoParamsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.UNIVERSALITY_TWO_PARAMS__Q);
			childrenFeatures.add(CombPackage.Literals.UNIVERSALITY_TWO_PARAMS__R);
		}
	...
	public String getText(Object object) {
		String label = ((UniversalityTwoParams) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_UniversalityTwoParams_type")
				: getString("_UI_UniversalityTwoParams_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UniversalityTwoParams.class)) {
