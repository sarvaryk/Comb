...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.MTLOperators} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MTLOperatorsItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MTLOperatorsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.MTL_OPERATORS__P);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MTLOperators"));
	}
	...
	public String getText(Object object) {
		String label = ((MTLOperators) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_MTLOperators_type")
				: getString("_UI_MTLOperators_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MTLOperators.class)) {
		case CombPackage.MTL_OPERATORS__P:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.create_until_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.createAlways_()));
		...
		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.createEventually_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.create_implies_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.createLiteral()));

		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors
				.add(createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.createNot_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.create_lessThan_()));

		newChildDescriptors.add(createChildParameter(CombPackage.Literals.MTL_OPERATORS__P,
				CombFactory.eINSTANCE.create_lessThanOrEqual_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.MTL_OPERATORS__P, CombFactory.eINSTANCE.create_equal_()));
