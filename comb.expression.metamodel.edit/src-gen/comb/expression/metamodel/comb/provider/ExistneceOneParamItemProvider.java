...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.ExistneceOneParam} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExistneceOneParamItemProvider extends ExistenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ExistneceOneParamItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.EXISTNECE_ONE_PARAM__Q);
		}
	...
	public String getText(Object object) {
		String label = ((ExistneceOneParam) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ExistneceOneParam_type")
				: getString("_UI_ExistneceOneParam_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExistneceOneParam.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTNECE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_and_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTNECE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTNECE_ONE_PARAM__Q, CombFactory.eINSTANCE.createNext_()));

		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.EXISTNECE_ONE_PARAM__Q, CombFactory.eINSTANCE.createNot_()));
