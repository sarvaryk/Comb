...
/**
 * This is the item provider adapter for a {@link comb.expression.metamodel.comb.PrecedenceOneParam} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrecedenceOneParamItemProvider extends PrecedenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PrecedenceOneParamItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CombPackage.Literals.PRECEDENCE_ONE_PARAM__Q);
		}
	...
	public String getText(Object object) {
		String label = ((PrecedenceOneParam) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_PrecedenceOneParam_type")
				: getString("_UI_PrecedenceOneParam_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrecedenceOneParam.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.PRECEDENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.create_or_()));
		...
		newChildDescriptors.add(
				createChildParameter(CombPackage.Literals.PRECEDENCE_ONE_PARAM__Q, CombFactory.eINSTANCE.createNot_()));
