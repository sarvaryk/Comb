 ...
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl._and_Impl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl._and_Impl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class _and_Impl extends BooleanOperatorsTwoParamsImpl implements _and_ {
	/**
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: <P> and <Q> becomes true in the given sub-expression.";
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals._AND_;
	}
	...
	public void setInterpretation(String newInterpretation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage._AND___INTERPRETATION, oldInterpretation,
					interpretation));
	}
