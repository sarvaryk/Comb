...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Always Within and </b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl.AlwaysWithin_and_Impl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.AlwaysWithin_and_Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.AlwaysWithin_and_Impl#getL <em>L</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.AlwaysWithin_and_Impl#getH <em>H</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlwaysWithin_and_Impl extends MITLOperatorsOneParamImpl implements AlwaysWithin_and_ {
	/**
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: <P> is always true within <low> and <high> time units in the given sub-expression.";
	 ...
	 * @generated
	 */
	protected AlwaysWithin_and_Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals.ALWAYS_WITHIN_AND_;
	}
	...
	public void setInterpretation(String newInterpretation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.ALWAYS_WITHIN_AND___INTERPRETATION,
	...
	public NotificationChain basicSetL(Literal newL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CombPackage.ALWAYS_WITHIN_AND___L, oldL, newL);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newL != l) {
			...
			if (l != null)
				msgs = ((InternalEObject) l).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CombPackage.ALWAYS_WITHIN_AND___L, null, msgs);
			if (newL != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.ALWAYS_WITHIN_AND___L, newL, newL));
	}
	...
	public NotificationChain basicSetH(Literal newH, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CombPackage.ALWAYS_WITHIN_AND___H, oldH, newH);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newH != h) {
			...
			if (h != null)
				msgs = ((InternalEObject) h).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CombPackage.ALWAYS_WITHIN_AND___H, null, msgs);
			if (newH != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.ALWAYS_WITHIN_AND___H, newH, newH));
	}
