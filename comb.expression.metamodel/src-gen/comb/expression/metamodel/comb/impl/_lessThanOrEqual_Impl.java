 ...
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl._lessThanOrEqual_Impl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl._lessThanOrEqual_Impl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class _lessThanOrEqual_Impl extends RelationImpl implements _lessThanOrEqual_ {
	/**
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: <P> is less than or equal to (<=) <Q>";
	 ...
	 * @generated
	 */
	protected _lessThanOrEqual_Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals._LESS_THAN_OR_EQUAL_;
	}
	...
	public void setInterpretation(String newInterpretation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage._LESS_THAN_OR_EQUAL___INTERPRETATION,
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage._LESS_THAN_OR_EQUAL___DESCRIPTION,
