 ...
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl._greaterThan_Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl._greaterThan_Impl#getInterpretation <em>Interpretation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class _greaterThan_Impl extends RelationImpl implements _greaterThan_ {
	/**
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: <P> is greater than (>) <Q>";
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals._GREATER_THAN_;
	}
