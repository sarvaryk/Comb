...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Always Within </b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl.AlwaysWithin_Impl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.AlwaysWithin_Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.AlwaysWithin_Impl#getH <em>H</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlwaysWithin_Impl extends MITLOperatorsOneParamImpl implements AlwaysWithin_ {
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: <P> is always true within <high> time units in the given sub-expression.";
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals.ALWAYS_WITHIN_;
	}
	...
	public void setInterpretation(String newInterpretation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.ALWAYS_WITHIN___INTERPRETATION,
	...
	public NotificationChain basicSetH(Literal newH, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CombPackage.ALWAYS_WITHIN___H, oldH, newH);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newH != h) {
			...
			if (h != null)
				msgs = ((InternalEObject) h).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CombPackage.ALWAYS_WITHIN___H, null, msgs);
			if (newH != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.ALWAYS_WITHIN___H, newH, newH));
	}
