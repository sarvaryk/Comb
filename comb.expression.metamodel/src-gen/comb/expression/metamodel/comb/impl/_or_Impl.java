 ...
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl._or_Impl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl._or_Impl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class _or_Impl extends BooleanOperatorsTwoParamsImpl implements _or_ {
	/**
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: <P> or <Q> becomes true in the given sub-expression.";
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals._OR_;
	}
	...
	public void setInterpretation(String newInterpretation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage._OR___INTERPRETATION, oldInterpretation,
					interpretation));
	}
