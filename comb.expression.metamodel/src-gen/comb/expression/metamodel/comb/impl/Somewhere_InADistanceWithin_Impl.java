 ...
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl.Somewhere_InADistanceWithin_Impl#getH <em>H</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.Somewhere_InADistanceWithin_Impl#getL <em>L</em>}</li>
...
public class Somewhere_InADistanceWithin_Impl extends STRELOperatorOneParamImpl
	 ...
	 * @ordered
	 */
	protected static final String INTERPRETATION_EDEFAULT = "SO[<high>] <P>";
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: there exists a route (with a lentgth <= <high>) to a location which satisfies <P>";
	...
	public NotificationChain basicSetH(Literal newH, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___H, oldH, newH);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newH != h) {
			...
			if (h != null)
				msgs = ((InternalEObject) h).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___H, null, msgs);
			if (newH != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___H, newH,
					newH));
	}
	...
	public NotificationChain basicSetL(Literal newL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___L, oldL, newL);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newL != l) {
			...
			if (l != null)
				msgs = ((InternalEObject) l).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___L, null, msgs);
			if (newL != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___L, newL,
					newL));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Spatial.class) {
			...
			case CombPackage.SPATIAL__H:
				return CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___H;
			case CombPackage.SPATIAL__L:
				return CombPackage.SOMEWHERE_IN_ADISTANCE_WITHIN___L;
			default:
				return -1;
			}
		}
