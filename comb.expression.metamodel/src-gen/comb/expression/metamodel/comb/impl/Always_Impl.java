 ...
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl.Always_Impl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.Always_Impl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Always_Impl extends LTLOperatorsOneParamImpl implements Always_ {
	/**
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals.ALWAYS_;
	}
	...
	public void setInterpretation(String newInterpretation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.ALWAYS___INTERPRETATION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CombPackage.ALWAYS___INTERPRETATION:
			return getInterpretation();
		case CombPackage.ALWAYS___DESCRIPTION:
