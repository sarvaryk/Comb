 ...
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl.Not_Impl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.Not_Impl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Not_Impl extends BooleanOperatorsOneParamImpl implements Not_ {
	/**
	 ...
	 * @ordered
	 */
	protected static final String DESCRIPTION_EDEFAULT = "The expression described by this element becomes true if: <P> is false in the given sub-expression.";
	...
	protected EClass eStaticClass() {
		return CombPackage.Literals.NOT_;
	}
	...
	public void setInterpretation(String newInterpretation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.NOT___INTERPRETATION, oldInterpretation,
					interpretation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CombPackage.NOT___INTERPRETATION:
			return getInterpretation();
		case CombPackage.NOT___DESCRIPTION:
