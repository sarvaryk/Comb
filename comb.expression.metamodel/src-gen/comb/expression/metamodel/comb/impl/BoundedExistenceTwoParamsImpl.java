...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bounded Existence Two Params</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link comb.expression.metamodel.comb.impl.BoundedExistenceTwoParamsImpl#getQ <em>Q</em>}</li>
 *   <li>{@link comb.expression.metamodel.comb.impl.BoundedExistenceTwoParamsImpl#getR <em>R</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BoundedExistenceTwoParamsImpl extends BoundedExistenceImpl implements BoundedExistenceTwoParams {
	/**
	 ...
	 * @generated
	 */
	protected BoundedExistenceTwoParamsImpl() {
		super();
	}
	...
	public NotificationChain basicSetR(Element newR, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CombPackage.BOUNDED_EXISTENCE_TWO_PARAMS__R, oldR, newR);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newR != r) {
			...
			if (r != null)
				msgs = ((InternalEObject) r).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CombPackage.BOUNDED_EXISTENCE_TWO_PARAMS__R, null, msgs);
			if (newR != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CombPackage.BOUNDED_EXISTENCE_TWO_PARAMS__R, newR,
					newR));
	}
